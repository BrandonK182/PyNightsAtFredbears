'''
class Fred extending Enemy class
*********************************************
This is a specific enemy that has access to the
right hallway and will not leave the hallway once he has entered.
Fred has a very long cooldown compared to the other enemies
**********************************************
variables
...
- populate_movement_table() - fills the movement_table with the
                              ...
                              can move towards
- reset() - return entity to the back of the hallway instead of
            the default main room
*********************************************
'''
